...
})({"lX4Ha":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "7346cab2413042e7";
"use strict";
...
},{}],"1Tzkw":[function(require,module,exports) {
...
*/ (0, _axiosDefault.default).get(`https://api.github.com/users/wolfaholic`).then((response)=>{
...
followersArray.forEach((user)=>{
    (0, _axiosDefault.default).get(`https://api.github.com/users/${user}`).then((data)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lX4Ha","1Tzkw"], "1Tzkw", "parcelRequirec83e")

//# sourceMappingURL=index.413042e7.js.map
